...
2. The two small transistors in the center of the board are not labled on the silkscreen.  Ensure the VP3203N is on the left and the 2N7000 is on the right
3. Make sure you get the LED polarity correct.  The long leg of the LED is positive and should be away from the flat side of the silkscreen symbol. 
